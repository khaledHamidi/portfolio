---
title: "دارات Buck وBoost: فهم آلية خفض ورفع الجهد وطريقة تصميمها"
summary: "شرح تعليمي متكامل لدارة Buck الخافضة للجهد ودارة Boost الرافعة للجهد، مع محاكاة عملية وشرح موجات الخرج وقوانين التصميم الأساسية."
date: 2019-11-08
authors:
  - admin
tags:
...
# ⚡ أولا: دارة Buck Converter (خافضة للجهد)

![محاكاة دارة Buck](buck.jpg)

## فكرة عمل دارة Buck

تقوم دارة Buck بخفض جهد الدخل إلى جهد خرج أصغر، مع الحفاظ على كفاءة عالية. العناصر الأساسية هي:
...
# ⚡ ثانيا: دارة Boost Converter (رافعة للجهد)
...
**مثال من المحاكاة:** عند D = 0.2 وجهد دخل 12V، نحسب $$ V_{out} = \frac{12}{1-0.2} = 15\; \text{V} $$
