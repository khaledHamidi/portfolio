...
# USAF Digital DATCOM – نماذج طائرات إيروديناميكية جاهزة للاستخدام

## ما هو Digital DATCOM؟

 برنامج حاسوبي طوّرته **القوات الجوية الأمريكية** لحساب خصائص الاستقرار والتحكم في الطائرات. يعتمد البرنامج على الأساليب الموثقة في كتيّب **USAF Stability and Control DATCOM**، وتم تطويره في الأصل في قاعدة Wright–Patterson الجوية.
 يمكن للبرنامج حساب:
