# [Creator's Blog: Hugo Theme](https://github.com/khaledHamidi/theme-blog)
...
- 🚀 [Contribute improvements](https://github.com/khaledHamidi/hugo-blox-builder/blob/main/CONTRIBUTING.md) or [suggest improvements](https://github.com/khaledHamidi/hugo-blox-builder/issues)
- ⬆️ **Updating?** View the [Update Guide](https://docs.hugoblox.com/) and [Release Notes](https://github.com/khaledHamidi/hugo-blox-builder/releases)
